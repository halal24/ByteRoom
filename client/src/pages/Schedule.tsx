    ...
    <div className="min-h-screen bg-dark-900 text-white flex">
      ...
      <div className="w-64 border-r border-white/10 flex flex-col p-4 bg-dark-800/50">
        ...
        <nav className="space-y-2 flex-1">
          <Link to="/dashboard" className="flex items-center gap-3 px-3 py-2 rounded-lg text-gray-400 hover:text-white hover:bg-white/5 transition-colors">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
            Dashboard
          </Link>
          <Link to="/schedule" className="flex items-center gap-3 px-3 py-2 rounded-lg bg-white/10 text-white">
